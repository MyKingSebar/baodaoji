...
public class ShinTextView extends TextView {




    public ShinTextView(Context context) {
        super(context);
    }

    public ShinTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public ShinTextView(Context context, @Nullable AttributeSet attrs, int defStyle) {
        ...
        if (mViewWidth == 0)
        {
            ...
            if (mViewWidth > 0)
            {
                ...
                mLinearGradient = new LinearGradient(0, 0, mViewWidth, 0,
                        new int[] { Color.RED, 0xffffffff,Color.RED }, null, Shader.TileMode.CLAMP);
                mPaint.setShader(mLinearGradient);
                mGradientMatrix = new Matrix();
            }
        }
